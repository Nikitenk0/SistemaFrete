...
class VehicleCreateDialog:

    def __init__(self, parent, create_vehicle_callback):
        ...
        self._window.title("Cadastrar veículo")
        ...
        self.form = VehicleForm(self._window, include_status=False)
        ...
        self._window.minsize(480, 300)
        self._window.geometry("560x360")
    ...
    def _save(self) -> None:
        ...
        self.status_label.configure(text="Cadastrando veículo...")
        self._task_runner.run(
            task=lambda: self._create_vehicle_callback(
                plate=data.plate,
    ...
    def _on_success(self, vehicle: Vehicle) -> None:
        ...
        messagebox.showinfo(
            "Sucesso",
            f"Veículo {vehicle.plate} cadastrado com sucesso.",
            parent=self._window,
        )
    ...
    def _on_error(self, error: Exception) -> None:
        if not self._exists():
            return
        self._is_saving = False
        self.save_button.configure(state="normal", text="Cadastrar")
