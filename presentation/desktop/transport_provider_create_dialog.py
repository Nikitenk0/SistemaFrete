...
class TransportProviderCreateDialog:
    ...
    def __init__(
        ...
        self._window.title("Novo prestador")
    ...
    def _save(self) -> None:
        ...
        self._task_runner.run(
            task=lambda: self._create_callback(
    ...
    def _set_saving(self, value: bool) -> None:
        ...
        self.save_button.configure(
            ...
            text="Salvando..." if value else "Salvar",
        )
