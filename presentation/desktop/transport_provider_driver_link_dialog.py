...
class TransportProviderDriverLinkDialog:
    ...
    def __init__(
        ...
        self._window.title("Vincular motorista")
        ...
        columns = ("driver_id", "name", "cpf", "cnh")
        ...
        role_frame.pack(fill="x", pady=(10, 8))
        ...
        self.role_combo.set(list(DRIVER_ROLE_OPTIONS)[0])
    ...
    def _show_results(self, items) -> None:
        ...
        self.status_label.configure(
            text=f"{len(items)} motorista(s) ativo(s)"
        )
    ...
    def _confirm(self) -> None:
        ...
        try:
            role = DRIVER_ROLE_OPTIONS[
                self.role_combo.get()
            ]
        except KeyError:
            return

        self.result = (driver, role)
