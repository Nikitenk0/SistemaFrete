...
class SqlAlchemyFreightVehicleRecordUnitOfWork(
    FreightVehicleRecordUnitOfWork
):
...
class SqlAlchemyFreightVehicleRecordUnitOfWorkFactory:
    ...
    def create(
        ...
        return SqlAlchemyFreightVehicleRecordUnitOfWork(
